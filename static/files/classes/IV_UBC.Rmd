...
p <- ggplot(data = data,
       mapping = aes(x = x, y = y)) +
  geom_point(fill = "steelblue", color = "black", shape = 21, size = 3) +
...
Coupled Human-Natural systems have feedbacks
...
--
.pull-left[Random shock in price of soy beans]
--
.pull-right[**Relevant**]
...
One estimation strategy is vis **Two-stage least squares (2SLS)**
