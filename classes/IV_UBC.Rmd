...
- Motivation: Problems with the use of ordinary least square regression while estimating the coefficient on an endogenous regressor
...
- Conditions necessary for a valid instrument:
  ...
  - (A story connecting these)
  
- Illustrate the use of this method for understanding environmental solutions
...
$y_{1i}$: The outcome for unit i if it had received treatment (i.e. $D_i = 1$)

$y_{0i}$: The outcome for unit i if it **did not** receive the treatment (i.e. $D_i = 0$)
...
- the endogenous part of $x$, which biases our results

--

- the exogenous part of $x$, which gives us unbiased estimates (what we care about)
...
## What is the effect of conservation status on species biodiversity?
...
We would love to calculate $Y_{1,i} - Y_{0,i}$, but we can't.
...
What is the effect of philanthropic investment on biodiversity conservation?

Can we simply regress a meassure of biodiversity on philanthropic spending?
